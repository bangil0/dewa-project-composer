...
class siakad_pt extends MX_Controller {
    ...
    function __construct() {
        ...
        $this->session->set_userdata('lihat','siakad_pt');
    ...
    public function index() {
        $this->template->set_title('Kelola Siakad_pt');
        $this->template->add_js('var baseurl="'.base_url().'siakad_pt/";','embed');  
        $this->template->load_view('siakad_pt_view',array(
            'view'=>'',
            'title'=>'Kelola Data Siakad_pt',
            'subtitle'=>'Pengelolaan Siakad_pt',
            'breadcrumb'=>array(
            'Siakad_pt'),
        ));
    }
    ...
    public function getdatatables(){
        if($this->isadmin()==1):
            ...
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('siakad_pt/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a>
            ...
            $this->datatables->select('kode_pt,nm_pt,tgl_pt,sk_pt,tgl_sk_pt,almt_pt,kota_pt,kodepos_pt,telp_pt,fax_pt,email_pt,web_pt,logo_pt,')
                            ->from('siakad_pt');
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('siakad_pt/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a></div>" , 'kode_pt');
            $this->datatables->unset_column('kode_pt');
        endif;
    ...
    function enkrip(){
        ...
        // echo $this->session->userdata('siakad_pt');
    }
    function isadmin(){
    ...
    function forms(){   
        ...
        $this->load->view('siakad_pt_form_inside');
