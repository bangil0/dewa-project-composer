...
class Tagihanbayar_detail_model extends CI_Model {
    ...
    function get_all($limit, $uri) {
        ...
        $result = $this->db->get('tagihanbayar_detail', $limit, $uri);
    ...
    function ceknomornull(){
        ...
        $result=$this->db->get('tagihanbayar_detail');
    ...
    function gettotaldetail($faktur){
        ...
        $this->db->from('tagihanbayar_detail');
    ...
    function __save(){
       ...
       $data = array(
            ...
            'idtarif' => $this->input->post('idtarif', TRUE),
           
            'nominal_tarif' => $this->input->post('nominal_tarif', TRUE),
    ...
    function savetagihanbayar_detail($data){
        $this->db->insert('tagihanbayar_detail',$data);
    }
    function save_detail($data){
        $this->db->insert('tagihanbayar_detail_detail',$data);
    }
    ...
    function delete_detail($id=null) {
        ...
        $this->db->delete('tagihanbayar_detail_detail'); 
    ...
    function get_dropdown_array($value){
        $result = array();
        $array_keys_values = $this->db->query('select id, '.$value.' from tagihanbayar_detail order by id asc');
