...
class rekeningmhs extends MX_Controller {
    ...
    $(document).on('show','#modal-id',function(){
    ...
    public function getdatatables(){
        if($this->isadmin()==1):
            $this->datatables->select('id,kode,kodemhs,kodejurnal,tanggal,saldoawal,debet,kredit,saldo,isactive,isdeleted,datedeleted,userid,datetime,')
                            ->from('rekeningmhs');
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('rekeningmhs/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a>
            ...
            $this->datatables->select('id,kode,kodemhs,kodejurnal,tanggal,saldoawal,debet,kredit,saldo,isactive,isdeleted,datedeleted,userid,datetime,')
                            ->from('rekeningmhs');
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('rekeningmhs/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a></div>" , 'id');
            $this->datatables->unset_column('id');
        endif;
    ...
    function enkrip(){
        ...
        // echo $this->session->userdata('rekeningmhs');
    }
    function isadmin(){
    ...
    function forms(){   
        ...
        $this->load->view('rekeningmhs_form_inside');
    ...
    function tables(){
        $this->load->view('rekeningmhs_data');
    }
