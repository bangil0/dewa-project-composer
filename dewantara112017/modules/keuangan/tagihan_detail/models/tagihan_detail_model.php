...
class Tagihan_detail_model extends CI_Model {
    ...
    function get_all($limit, $uri) {
        ...
        $result = $this->db->get('tagihan_detail', $limit, $uri);
    ...
    function __save(){
       ...
       $data = array(
            ...
            'kodetagihan' => $this->input->post('kodetagihan', TRUE),
           
            'kodetarif' => $this->input->post('kodetarif', TRUE),
           
            'istagihan' => $this->input->post('istagihan', TRUE),
    ...
    function savetagihan_detail($data){
        $this->db->insert('tagihan_detail',$data);
    }
    function save_detail($data){
        $this->db->insert('tagihan_detail_detail',$data);
    }
    ...
    function delete_detail($id=null) {
        ...
        $this->db->delete('tagihan_detail_detail'); 
    ...
    function get_dropdown_array($value){
        $result = array();
        $array_keys_values = $this->db->query('select id, '.$value.' from tagihan_detail order by id asc');
