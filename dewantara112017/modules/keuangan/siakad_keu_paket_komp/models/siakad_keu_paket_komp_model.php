...
class Siakad_keu_paket_komp_model extends CI_Model {
    ...
    function get_all($limit, $uri) {
        ...
        $result = $this->db->get('siakad_keu_paket_komp', $limit, $uri);
    ...
    function ceknomornull(){
        ...
        $this->db->order_by('id_siakad_keu_paket_komp','ASC');
        $this->db->limit(1);

        $result=$this->db->get('siakad_keu_paket_komp');
    ...
    function get_last(){
        ...
        $this->db->select('*'); //faktur
        $this->db->order_by('id_siakad_keu_paket_komp','DESC');
        $this->db->limit(1);
    ...
    function gettotaldetail($faktur){
        ...
        $this->db->from('siakad_keu_paket_komp');
    ...
    function get_one($id_siakad_keu_paket_komp) {
        $this->db->where('id_siakad_keu_paket_komp', $id_siakad_keu_paket_komp);
        $result = $this->db->get('siakad_keu_paket_komp');
        if ($result->num_rows() == 1) {
            return $result->row_array();
        } else {
    ...
    function savesiakad_keu_paket_komp($data){
        $this->db->insert('siakad_keu_paket_komp',$data);
    }
    function save_detail($data){
        $this->db->insert('siakad_keu_paket_komp_detail',$data);
    }
    function upddel_detail($id_siakad_keu_paket_komp=null) {
    ...
    function updatebyid($id_siakad_keu_paket_komp,$data){
        $this->db->where('id_siakad_keu_paket_komp', $id_siakad_keu_paket_komp);
        $this->db->update('siakad_keu_paket_komp', $data);
    }
    function update($id_siakad_keu_paket_komp) {
        $data = array(
        'id_siakad_keu_paket_komp' => $this->input->post('id_siakad_keu_paket_komp',TRUE),
       'id_siakad_keu_paket' => $this->input->post('id_siakad_keu_paket', TRUE),
    ...
    function delete($id_siakad_keu_paket_komp) {
        $this->db->where('id_siakad_keu_paket_komp', $id_siakad_keu_paket_komp);
        $this->db->delete('siakad_keu_paket_komp'); 
       
    }
    function delete_detail($id=null) {
        $this->db->where('id_detail', $id);
        $this->db->delete('siakad_keu_paket_komp_detail'); 
    ...
    function get_dropdown_array($value){
        $result = array();
        $array_keys_values = $this->db->query('select id_siakad_keu_paket_komp, '.$value.' from siakad_keu_paket_komp order by id_siakad_keu_paket_komp asc');
        $result[0]="-- Pilih Urutan id_siakad_keu_paket_komp --";
        foreach ($array_keys_values->result() as $row)
        {
            $result[$row->id_siakad_keu_paket_komp]= $row->$value;
        }
        return $result;
    }
