...
class Prodi_model extends CI_Model {
    ...
    function get_all($limit, $uri) {
        ...
        $result = $this->db->get('prodi', $limit, $uri);
    ...
    function saveprodi($data){
        $this->db->insert('prodi',$data);
    }
    function save_detail($data){
        $this->db->insert('prodi_detail',$data);
    }
    function upddel_detail($KodeP=null) {
    ...
    function updatebyid($KodeP,$data){
        $this->db->where('KodeP', $KodeP);
        $this->db->update('prodi', $data);
    }
    function update($KodeP) {
        $data = array(
        'KodeP' => $this->input->post('KodeP',TRUE),
       'Prodi' => $this->input->post('Prodi', TRUE),
    ...
    function get_dropdown_array($value){
        $result = array();
        $array_keys_values = $this->db->query('select KodeP, '.$value.' from prodi order by KodeP asc');
        $result[0]="-- Pilih Urutan KodeP --";
        foreach ($array_keys_values->result() as $row)
        {
            $result[$row->KodeP]= $row->$value;
        }
        return $result;
    }
    ...
    function get_dropdown_array($value){
        $result = array();
        $array_keys_values = $this->db->query('select id, '.$value.' from prodi order by id asc');
