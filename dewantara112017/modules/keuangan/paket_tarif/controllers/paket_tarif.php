...
class paket_tarif extends MX_Controller {
    ...
    public function getdatatables(){
        if($this->isadmin()==1):
            $this->datatables->select('id,kodepaket,kodetarif,isactive,isdeleted,datedeleted,userid,datetime,')
                            ->from('paket_tarif');
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('paket_tarif/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a>
            ...
            $this->datatables->select('id,kodepaket,kodetarif,isactive,isdeleted,datedeleted,userid,datetime,')
                            ->from('paket_tarif');
            $this->datatables->add_column('edit',"<div class='btn-group'>
                <a data-toggle='modal' href='#modal-id' data-load-remote='".base_url('paket_tarif/getone/$1/')."' data-remote-target='#modal-id .modal-body' class='btn btn-info btn-xs'><i class='fa fa-info-circle'></i> </a></div>" , 'id');
            $this->datatables->unset_column('id');
        endif;
    ...
    function enkrip(){
        ...
        // echo $this->session->userdata('paket_tarif');
    }
    function isadmin(){
    ...
    function forms(){   
        ...
        $this->load->view('paket_tarif_form_inside');
    ...
    function tables(){
        $this->load->view('paket_tarif_data');
    }
