...
class Paket_tarif_model extends CI_Model {
    ...
    function get_all($limit, $uri) {
        ...
        $result = $this->db->get('paket_tarif', $limit, $uri);
    ...
    function ceknomornull(){
        ...
        $result=$this->db->get('paket_tarif');
    ...
    function save() {
        $data=$this->__save();
        $this->db->insert('paket_tarif', $data);
    }
    function saveas() {
        $data=$this->__saveas();
        $this->db->insert('paket_tarif', $data);
    ...
    function __save(){
       ...
       $data = array(
            ...
            'kodepaket' => $this->input->post('kodepaket', TRUE),
    ...
    function savepaket_tarif($data){
        $this->db->insert('paket_tarif',$data);
    }
    function save_detail($data){
        $this->db->insert('paket_tarif_detail',$data);
    }
    function upddel_detail($id=null) {
        ...
        $this->db->where('id', $id);
        $this->db->update('paket_tarif', $data);
    ...
    function delete($id) {
        $this->db->where('id', $id);
        $this->db->delete('paket_tarif'); 
       
    }
    function delete_detail($id=null) {
        $this->db->where('id_detail', $id);
        $this->db->delete('paket_tarif_detail'); 
    ...
    function get_dropdown_array($value){
        $result = array();
        $array_keys_values = $this->db->query('select id, '.$value.' from paket_tarif order by id asc');
