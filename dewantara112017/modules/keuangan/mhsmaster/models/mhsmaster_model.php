...
class Mhsmaster_model extends CI_Model {
    ...
    function get_all($limit, $uri) {
        ...
        $result = $this->db->get('mhsmaster', $limit, $uri);
    ...
    function savemhsmaster($data){
        $this->db->insert('mhsmaster',$data);
    }
    function save_detail($data){
        $this->db->insert('mhsmaster_detail',$data);
    }
    ...
    function delete($id) {
        $this->db->where('id', $id);
        $this->db->delete('mhsmaster'); 
       
    }
    function delete_detail($id=null) {
        $this->db->where('id_detail', $id);
        $this->db->delete('mhsmaster_detail'); 
    ...
    function get_dropdown_array($value){
        $result = array();
        $array_keys_values = $this->db->query('select id, '.$value.' from mhsmaster order by id asc');
